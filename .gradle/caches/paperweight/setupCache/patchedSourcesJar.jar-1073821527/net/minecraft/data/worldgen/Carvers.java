...
public class Carvers {
    ...
    private static <WC extends CarverConfiguration> Holder<ConfiguredWorldCarver<WC>> register(String id, ConfiguredWorldCarver<WC> configuredCarver) {
        return BuiltinRegistries.registerExact(BuiltinRegistries.CONFIGURED_CARVER, id, configuredCarver);
    }
}
