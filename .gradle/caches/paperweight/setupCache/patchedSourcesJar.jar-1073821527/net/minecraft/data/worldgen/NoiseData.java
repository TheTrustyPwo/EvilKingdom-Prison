...
public class NoiseData {
    ...
    private static void registerBiomeNoises(int firstOctaveOffset, ResourceKey<NormalNoise.NoiseParameters> temperature, ResourceKey<NormalNoise.NoiseParameters> vegetation, ResourceKey<NormalNoise.NoiseParameters> continentalness, ResourceKey<NormalNoise.NoiseParameters> erosion) {
        register(temperature, -10 + firstOctaveOffset, 1.5D, 0.0D, 1.0D, 0.0D, 0.0D, 0.0D);
        register(vegetation, -8 + firstOctaveOffset, 1.0D, 1.0D, 0.0D, 0.0D, 0.0D, 0.0D);
        register(continentalness, -9 + firstOctaveOffset, 1.0D, 1.0D, 2.0D, 2.0D, 2.0D, 1.0D, 1.0D, 1.0D, 1.0D);
        register(erosion, -9 + firstOctaveOffset, 1.0D, 1.0D, 0.0D, 1.0D, 1.0D);
    }
