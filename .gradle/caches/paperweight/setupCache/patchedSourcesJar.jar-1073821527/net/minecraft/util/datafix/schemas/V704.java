...
public class V704 extends Schema {
    ...
    public Type<?> getChoiceType(TypeReference typeReference, String string) {
        return Objects.equals(typeReference.typeName(), References.BLOCK_ENTITY.typeName()) ? super.getChoiceType(typeReference, NamespacedSchema.ensureNamespaced(string)) : super.getChoiceType(typeReference, string);
    }
    ...
    public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map2) {
        ...
        schema.registerType(false, References.BLOCK_ENTITY, () -> {
            return DSL.taggedChoiceLazy("id", NamespacedSchema.namespacedString(), map2);
        });
