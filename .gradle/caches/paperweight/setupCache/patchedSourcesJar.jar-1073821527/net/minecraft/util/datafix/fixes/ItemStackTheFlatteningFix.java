...
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    private static final Set<String> IDS = MAP.keySet().stream().map((string) -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, (typed) -> {
            ...
            if (!optional.isPresent()) {
                ...
                String string = updateItem(optional.get().getSecond(), i);
                if (string != null) {
    ...
    public static String updateItem(@Nullable String originalName, int damage) {
        if (IDS.contains(originalName)) {
            String string = MAP.get(originalName + "." + damage);
            return string == null ? MAP.get(originalName + ".0") : string;
        } else {
            return null;
        }
    }
