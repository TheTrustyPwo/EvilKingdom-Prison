...
public class ScoreboardSlotArgument implements ArgumentType<Integer> {
    ...
    public static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType((name) -> {
        return new TranslatableComponent("argument.scoreboardDisplaySlot.invalid", name);
    });
    ...
    public static int getDisplaySlot(CommandContext<CommandSourceStack> context, String name) {
