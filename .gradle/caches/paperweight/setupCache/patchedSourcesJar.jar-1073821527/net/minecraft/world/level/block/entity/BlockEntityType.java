...
public class BlockEntityType<T extends BlockEntity> {
    ...
    public static ResourceLocation getKey(BlockEntityType<?> type) {
        return Registry.BLOCK_ENTITY_TYPE.getKey(type);
    }
    ...
    public static final class Builder<T extends BlockEntity> {
        ...
        private Builder(BlockEntityType.BlockEntitySupplier<? extends T> factory, Set<Block> blocks) {
            this.factory = factory;
            this.validBlocks = blocks;
        }

        public static <T extends BlockEntity> BlockEntityType.Builder<T> of(BlockEntityType.BlockEntitySupplier<? extends T> factory, Block... blocks) {
