...
public class NumberProviders {
    ...
    private static LootNumberProviderType register(String id, Serializer<? extends NumberProvider> jsonSerializer) {
        return Registry.register(Registry.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(id), new LootNumberProviderType(jsonSerializer));
    }
