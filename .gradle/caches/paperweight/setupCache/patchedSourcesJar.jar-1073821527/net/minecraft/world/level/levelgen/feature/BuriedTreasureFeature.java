...
public class BuriedTreasureFeature extends StructureFeature<ProbabilityFeatureConfiguration> {
    ...
    public BuriedTreasureFeature(Codec<ProbabilityFeatureConfiguration> configCodec) {
        super(configCodec, PieceGeneratorSupplier.simple(BuriedTreasureFeature::checkLocation, BuriedTreasureFeature::generatePieces));
    }
    ...
    private static void generatePieces(StructurePiecesBuilder collector, PieceGenerator.Context<ProbabilityFeatureConfiguration> context) {
