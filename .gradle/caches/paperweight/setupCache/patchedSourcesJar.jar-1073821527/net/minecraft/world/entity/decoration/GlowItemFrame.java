...
public class GlowItemFrame extends ItemFrame {
    public GlowItemFrame(EntityType<? extends ItemFrame> type, Level world) {
        super(type, world);
    }

    public GlowItemFrame(Level world, BlockPos pos, Direction facing) {
        super(EntityType.GLOW_ITEM_FRAME, world, pos, facing);
    }
