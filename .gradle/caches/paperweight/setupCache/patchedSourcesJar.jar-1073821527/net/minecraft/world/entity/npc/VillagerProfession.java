...
public class VillagerProfession {
    ...
    private VillagerProfession(String id, PoiType workStation, ImmutableSet<Item> gatherableItems, ImmutableSet<Block> secondaryJobSites, @Nullable SoundEvent workSound) {
        this.name = id;
    ...
    static VillagerProfession register(String id, PoiType workStation, @Nullable SoundEvent workSound) {
