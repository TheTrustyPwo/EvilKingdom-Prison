...
public final class Matrix4f {
    ...
    private static boolean isInteger(float value) {
        return (double)Math.abs(value - (float)Math.round(value)) <= 1.0E-5D;
    }
    ...
    public void loadTransposed(FloatBuffer buf) {
        ...
        this.m03 = buf.get(bufferIndex(3, 0));
        this.m10 = buf.get(bufferIndex(0, 1));
        this.m11 = buf.get(bufferIndex(1, 1));
        this.m12 = buf.get(bufferIndex(2, 1));
        this.m13 = buf.get(bufferIndex(3, 1));
        this.m20 = buf.get(bufferIndex(0, 2));
        this.m21 = buf.get(bufferIndex(1, 2));
        this.m22 = buf.get(bufferIndex(2, 2));
        this.m23 = buf.get(bufferIndex(3, 2));
        this.m30 = buf.get(bufferIndex(0, 3));
        this.m31 = buf.get(bufferIndex(1, 3));
        this.m32 = buf.get(bufferIndex(2, 3));
        this.m33 = buf.get(bufferIndex(3, 3));
    }
    ...
    public void store(FloatBuffer buf) {
        ...
        buf.put(bufferIndex(0, 3), this.m03);
        buf.put(bufferIndex(1, 0), this.m10);
        buf.put(bufferIndex(1, 1), this.m11);
        buf.put(bufferIndex(1, 2), this.m12);
        buf.put(bufferIndex(1, 3), this.m13);
        buf.put(bufferIndex(2, 0), this.m20);
        buf.put(bufferIndex(2, 1), this.m21);
        buf.put(bufferIndex(2, 2), this.m22);
        buf.put(bufferIndex(2, 3), this.m23);
        buf.put(bufferIndex(3, 0), this.m30);
        buf.put(bufferIndex(3, 1), this.m31);
        buf.put(bufferIndex(3, 2), this.m32);
        buf.put(bufferIndex(3, 3), this.m33);
    }
    ...
    public void storeTransposed(FloatBuffer buf) {
        ...
        buf.put(bufferIndex(3, 0), this.m03);
        buf.put(bufferIndex(0, 1), this.m10);
        buf.put(bufferIndex(1, 1), this.m11);
        buf.put(bufferIndex(2, 1), this.m12);
        buf.put(bufferIndex(3, 1), this.m13);
        buf.put(bufferIndex(0, 2), this.m20);
        buf.put(bufferIndex(1, 2), this.m21);
        buf.put(bufferIndex(2, 2), this.m22);
        buf.put(bufferIndex(3, 2), this.m23);
        buf.put(bufferIndex(0, 3), this.m30);
        buf.put(bufferIndex(1, 3), this.m31);
        buf.put(bufferIndex(2, 3), this.m32);
        buf.put(bufferIndex(3, 3), this.m33);
    }
    ...
    public void multiply(Matrix4f matrix) {
        ...
        float g = this.m00 * matrix.m01 + this.m01 * matrix.m11 + this.m02 * matrix.m21 + this.m03 * matrix.m31;
        float h = this.m00 * matrix.m02 + this.m01 * matrix.m12 + this.m02 * matrix.m22 + this.m03 * matrix.m32;
        float i = this.m00 * matrix.m03 + this.m01 * matrix.m13 + this.m02 * matrix.m23 + this.m03 * matrix.m33;
        float j = this.m10 * matrix.m00 + this.m11 * matrix.m10 + this.m12 * matrix.m20 + this.m13 * matrix.m30;
        float k = this.m10 * matrix.m01 + this.m11 * matrix.m11 + this.m12 * matrix.m21 + this.m13 * matrix.m31;
        float l = this.m10 * matrix.m02 + this.m11 * matrix.m12 + this.m12 * matrix.m22 + this.m13 * matrix.m32;
        float m = this.m10 * matrix.m03 + this.m11 * matrix.m13 + this.m12 * matrix.m23 + this.m13 * matrix.m33;
        float n = this.m20 * matrix.m00 + this.m21 * matrix.m10 + this.m22 * matrix.m20 + this.m23 * matrix.m30;
        float o = this.m20 * matrix.m01 + this.m21 * matrix.m11 + this.m22 * matrix.m21 + this.m23 * matrix.m31;
        float p = this.m20 * matrix.m02 + this.m21 * matrix.m12 + this.m22 * matrix.m22 + this.m23 * matrix.m32;
        float q = this.m20 * matrix.m03 + this.m21 * matrix.m13 + this.m22 * matrix.m23 + this.m23 * matrix.m33;
        float r = this.m30 * matrix.m00 + this.m31 * matrix.m10 + this.m32 * matrix.m20 + this.m33 * matrix.m30;
        float s = this.m30 * matrix.m01 + this.m31 * matrix.m11 + this.m32 * matrix.m21 + this.m33 * matrix.m31;
        float t = this.m30 * matrix.m02 + this.m31 * matrix.m12 + this.m32 * matrix.m22 + this.m33 * matrix.m32;
        float u = this.m30 * matrix.m03 + this.m31 * matrix.m13 + this.m32 * matrix.m23 + this.m33 * matrix.m33;
        this.m00 = f;
        this.m01 = g;
        this.m02 = h;
        this.m03 = i;
    ...
    public static Matrix4f perspective(double fov, float aspectRatio, float cameraDepth, float viewDistance) {
        float f = (float)(1.0D / Math.tan(fov * (double)((float)Math.PI / 180F) / 2.0D));
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.m00 = f / aspectRatio;
        matrix4f.m11 = f;
        matrix4f.m22 = (viewDistance + cameraDepth) / (cameraDepth - viewDistance);
        matrix4f.m32 = -1.0F;
        matrix4f.m23 = 2.0F * viewDistance * cameraDepth / (cameraDepth - viewDistance);
        return matrix4f;
    }
