...
public enum SymmetricGroup3 {
    ...
    private static final SymmetricGroup3[][] cayleyTable = Util.make(new SymmetricGroup3[values().length][values().length], (symmetricGroup3s) -> {
        for(SymmetricGroup3 symmetricGroup3 : values()) {
            for(SymmetricGroup3 symmetricGroup32 : values()) {
                ...
                SymmetricGroup3 symmetricGroup33 = Arrays.stream(values()).filter((symmetricGroup3x) -> {
    ...
    private SymmetricGroup3(int xMapping, int yMapping, int zMapping) {
    ...
    public SymmetricGroup3 compose(SymmetricGroup3 transformation) {
