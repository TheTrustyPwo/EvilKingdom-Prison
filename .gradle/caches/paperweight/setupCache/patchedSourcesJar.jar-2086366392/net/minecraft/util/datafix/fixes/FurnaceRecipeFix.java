...
public class FurnaceRecipeFix extends DataFix {
    ...
    private <R> TypeRewriteRule cap(Type<R> type) {
        Type<Pair<Either<Pair<List<Pair<R, Integer>>, Dynamic<?>>, Unit>, Dynamic<?>>> type2 = DSL.and(DSL.optional(DSL.field("RecipesUsed", DSL.and(DSL.compoundList(type, DSL.intType()), DSL.remainderType()))), DSL.remainderType());
        ...
        return this.fixTypeEverywhereTyped("FurnaceRecipesFix", type6, type7, (typed) -> {
            return typed.updateTyped(opticFinder, type3, (typedx) -> {
                return this.updateFurnaceContents(type, type2, typedx);
