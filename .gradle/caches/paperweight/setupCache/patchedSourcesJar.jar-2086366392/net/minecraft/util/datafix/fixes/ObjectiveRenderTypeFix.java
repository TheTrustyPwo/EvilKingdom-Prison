...
public class ObjectiveRenderTypeFix extends DataFix {
    ...
    private static ObjectiveCriteria.RenderType getRenderType(String oldName) {
        return oldName.equals("health") ? ObjectiveCriteria.RenderType.HEARTS : ObjectiveCriteria.RenderType.INTEGER;
    }
