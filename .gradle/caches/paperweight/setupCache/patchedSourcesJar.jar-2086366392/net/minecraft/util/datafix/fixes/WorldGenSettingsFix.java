...
public class WorldGenSettingsFix extends DataFix {
                        ...
                        if ("stronghold".equals(string)) {
                            ...
                            case "separation":
                                if ("oceanmonument".equals(string)) {
                                    WorldGenSettingsFix.StructureFeatureConfiguration structureFeatureConfiguration = map.getOrDefault("minecraft:monument", DEFAULTS.get("minecraft:monument"));
                                    int i = getInt(string3, structureFeatureConfiguration.separation, 1);
                                    map.put("minecraft:monument", new WorldGenSettingsFix.StructureFeatureConfiguration(i, structureFeatureConfiguration.separation, structureFeatureConfiguration.salt));
                                }
    ...
    private static void setSpacing(Map<String, WorldGenSettingsFix.StructureFeatureConfiguration> map, String string, String string2, int i) {
        WorldGenSettingsFix.StructureFeatureConfiguration structureFeatureConfiguration = map.getOrDefault(string, DEFAULTS.get(string));
