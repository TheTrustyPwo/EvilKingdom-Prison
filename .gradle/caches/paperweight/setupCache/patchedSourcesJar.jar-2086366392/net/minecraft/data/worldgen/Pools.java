...
public class Pools {
    ...
    public static Holder<StructureTemplatePool> register(StructureTemplatePool templatePool) {
        return BuiltinRegistries.register(BuiltinRegistries.TEMPLATE_POOL, templatePool.getName(), templatePool);
    }
