...
public class MapBanner {
    ...
    public MapBanner(BlockPos pos, DyeColor dyeColor, @Nullable Component name) {
        this.pos = pos;
        this.color = dyeColor;
        this.name = name;
    }

    public static MapBanner load(CompoundTag nbt) {
        ...
        Component component = nbt.contains("Name") ? Component.Serializer.fromJson(nbt.getString("Name")) : null;
        return new MapBanner(blockPos, dyeColor, component);
    }

    @Nullable
    public static MapBanner fromWorld(BlockGetter blockView, BlockPos blockPos) {
