...
public enum MobCategory implements StringRepresentable {
    ...
    private static final Map<String, MobCategory> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(MobCategory::getName, (spawnGroup) -> {
        return spawnGroup;
    }));
    ...
    private MobCategory(String name, int spawnCap, boolean peaceful, boolean rare, int immediateDespawnRange) {
        this.name = name;
        this.max = spawnCap;
