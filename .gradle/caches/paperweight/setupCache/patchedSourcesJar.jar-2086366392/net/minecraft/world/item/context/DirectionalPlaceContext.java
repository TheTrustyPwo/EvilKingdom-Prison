...
public class DirectionalPlaceContext extends BlockPlaceContext {
    ...
    public DirectionalPlaceContext(Level world, BlockPos pos, Direction facing, ItemStack stack, Direction side) {
        super(world, (Player)null, InteractionHand.MAIN_HAND, stack, new BlockHitResult(Vec3.atBottomCenterOf(pos), side, pos, false));
