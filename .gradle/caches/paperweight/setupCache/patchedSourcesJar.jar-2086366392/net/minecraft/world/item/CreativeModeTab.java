...
public abstract class CreativeModeTab {
    ...
    public CreativeModeTab(int index, String id) {
        this.id = index;
        this.langId = id;
        this.displayName = new TranslatableComponent("itemGroup." + id);
    ...
    public CreativeModeTab setEnchantmentCategories(EnchantmentCategory... targets) {
        this.enchantmentCategories = targets;
        return this;
    }

    public boolean hasEnchantmentCategory(@Nullable EnchantmentCategory target) {
        if (target != null) {
