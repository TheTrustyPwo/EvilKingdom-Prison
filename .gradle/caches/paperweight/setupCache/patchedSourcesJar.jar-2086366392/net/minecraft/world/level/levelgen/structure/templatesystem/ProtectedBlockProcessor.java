...
public class ProtectedBlockProcessor extends StructureProcessor {
    ...
    public static final Codec<ProtectedBlockProcessor> CODEC = TagKey.hashedCodec(Registry.BLOCK_REGISTRY).xmap(ProtectedBlockProcessor::new, (protectedBlockProcessor) -> {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader world, BlockPos pos, BlockPos pivot, StructureTemplate.StructureBlockInfo structureBlockInfo, StructureTemplate.StructureBlockInfo structureBlockInfo2, StructurePlaceSettings data) {
        return Feature.isReplaceable(this.cannotReplace).test(world.getBlockState(structureBlockInfo2.pos)) ? structureBlockInfo2 : null;
    }
