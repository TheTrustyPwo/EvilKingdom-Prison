...
public class MoveBackToVillageGoal extends RandomStrollGoal {
    ...
    public MoveBackToVillageGoal(PathfinderMob entity, double speed, boolean canDespawn) {
    ...
    protected Vec3 getPosition() {
        ...
        return sectionPos2 != sectionPos ? DefaultRandomPos.getPosTowards(this.mob, 10, 7, Vec3.atBottomCenterOf(sectionPos2.center()), (double)((float)Math.PI / 2F)) : null;
    }
}
