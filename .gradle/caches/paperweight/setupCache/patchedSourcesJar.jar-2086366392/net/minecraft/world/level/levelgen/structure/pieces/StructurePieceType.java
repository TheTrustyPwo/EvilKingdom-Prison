...
public interface StructurePieceType {
    ...
    StructurePiece load(StructurePieceSerializationContext context, CompoundTag nbt);
    ...
    public interface ContextlessType extends StructurePieceType {
        StructurePiece load(CompoundTag nbt);

        @Override
        default StructurePiece load(StructurePieceSerializationContext context, CompoundTag nbt) {
            return this.load(nbt);
        }
    }

    public interface StructureTemplateType extends StructurePieceType {
        StructurePiece load(StructureManager structureManager, CompoundTag nbt);
