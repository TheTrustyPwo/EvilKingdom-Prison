...
public class VillagerTrades {
    ...
    static class EmeraldForItems implements VillagerTrades.ItemListing {
        ...
        public EmeraldForItems(ItemLike item, int price, int maxUses, int experience) {
    ...
    static class EnchantBookForEmeralds implements VillagerTrades.ItemListing {
        ...
        public EnchantBookForEmeralds(int experience) {
            this.villagerXp = experience;
        }
    ...
    static class ItemsAndEmeraldsToItems implements VillagerTrades.ItemListing {
        ...
        public ItemsAndEmeraldsToItems(ItemLike item, int secondCount, Item sellItem, int sellCount, int maxUses, int experience) {
            this(item, secondCount, 1, sellItem, sellCount, maxUses, experience);
        }

        public ItemsAndEmeraldsToItems(ItemLike item, int secondCount, int price, Item sellItem, int sellCount, int maxUses, int experience) {
            this.fromItem = new ItemStack(item);
            this.fromCount = secondCount;
            this.emeraldCost = price;
            this.toItem = new ItemStack(sellItem);
    ...
    static class SuspiciousStewForEmerald implements VillagerTrades.ItemListing {
        ...
        public SuspiciousStewForEmerald(MobEffect effect, int duration, int experience) {
            this.effect = effect;
    ...
    static class TreasureMapForEmeralds implements VillagerTrades.ItemListing {
        ...
        public TreasureMapForEmeralds(int price, TagKey<ConfiguredStructureFeature<?, ?>> structure, String nameKey, MapDecoration.Type iconType, int maxUses, int experience) {
            this.emeraldCost = price;
