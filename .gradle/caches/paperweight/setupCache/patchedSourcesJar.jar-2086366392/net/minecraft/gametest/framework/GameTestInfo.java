...
public class GameTestInfo {
    ...
    public GameTestInfo(TestFunction testFunction, Rotation rotation, ServerLevel world) {
    ...
    public void spawnStructure(BlockPos pos, int i) {
        this.structureBlockEntity = StructureUtils.spawnStructure(this.getStructureName(), pos, this.getRotation(), i, this.level, false);
