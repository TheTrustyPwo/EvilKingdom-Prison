...
public class ClientboundGameEventPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundGameEventPacket(ClientboundGameEventPacket.Type reason, float value) {
        this.event = reason;
        this.param = value;
    }

    public ClientboundGameEventPacket(FriendlyByteBuf buf) {
        this.event = ClientboundGameEventPacket.Type.TYPES.get(buf.readUnsignedByte());
