...
public class ChaseServer {
    ...
    private ChaseServer.PlayerPosition getPlayerPosition() {
        ...
        if (list.isEmpty()) {
            ...
            String string = ChaseCommand.DIMENSION_NAMES.inverse().get(serverPlayer.getLevel().dimension());
            return string == null ? null : new ChaseServer.PlayerPosition(string, serverPlayer.getX(), serverPlayer.getY(), serverPlayer.getZ(), serverPlayer.getYRot(), serverPlayer.getXRot());
        }
    }
