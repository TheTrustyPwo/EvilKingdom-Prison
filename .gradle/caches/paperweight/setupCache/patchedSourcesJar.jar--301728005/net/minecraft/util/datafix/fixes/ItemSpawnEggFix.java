...
public class ItemSpawnEggFix extends DataFix {
    public static final String[] ID_TO_ENTITY = DataFixUtils.make(new String[256], (strings) -> {
        strings[1] = "Item";
        strings[2] = "XPOrb";
        strings[7] = "ThrownEgg";
        strings[8] = "LeashKnot";
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (typed) -> {
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:spawn_egg")) {
                ...
                Optional<? extends Typed<?>> optional3 = optional2.flatMap((typedx) -> {
                    return typedx.getOptionalTyped(opticFinder4);
                });
                Optional<? extends Typed<?>> optional4 = optional3.flatMap((typedx) -> {
                    return typedx.getOptionalTyped(opticFinder5);
                });
                Optional<String> optional5 = optional4.flatMap((typedx) -> {
                    return typedx.getOptional(opticFinder2);
                });
                Typed<?> typed2 = typed;
                ...
                if (string != null && (!optional5.isPresent() || !Objects.equals(optional5.get(), string))) {
                    ...
                    Typed<?> typed6 = typed5.write().flatMap((dynamic2x) -> {
                        return type2.readTyped(dynamic2x.set("id", dynamic2.createString(string)));
                    }).result().orElseThrow(() -> {
