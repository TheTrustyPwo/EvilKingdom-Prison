...
public enum BannerPattern {
    ...
    public ResourceLocation location(boolean banner) {
    ...
    @Nullable
    public static BannerPattern byHash(String id) {
    ...
    @Nullable
    public static BannerPattern byFilename(String name) {
        for(BannerPattern bannerPattern : values()) {
    ...
    public static class Builder {
        ...
        public BannerPattern.Builder addPattern(BannerPattern pattern, DyeColor color) {
            return this.addPattern(Pair.of(pattern, color));
        }

        public BannerPattern.Builder addPattern(Pair<BannerPattern, DyeColor> pattern) {
