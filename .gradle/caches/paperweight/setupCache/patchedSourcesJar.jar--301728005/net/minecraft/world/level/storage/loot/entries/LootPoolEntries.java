...
public class LootPoolEntries {
    ...
    private static LootPoolEntryType register(String id, Serializer<? extends LootPoolEntryContainer> jsonSerializer) {
        return Registry.register(Registry.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(id), new LootPoolEntryType(jsonSerializer));
    }
