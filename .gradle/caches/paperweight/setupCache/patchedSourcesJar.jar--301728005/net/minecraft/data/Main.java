...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!optionSet.has(optionSpec) && optionSet.hasOptions()) {
            ...
            DataGenerator dataGenerator = createStandardGenerator(path, optionSet.valuesOf(optionSpec9).stream().map((string) -> {
    ...
    public static DataGenerator createStandardGenerator(Path output, Collection<Path> inputs, boolean includeClient, boolean includeServer, boolean includeDev, boolean includeReports, boolean validate) {
