...
public class VegetationPlacements {
    ...
    private static List<PlacementModifier> getMushroomPlacement(int chance, @Nullable PlacementModifier modifier) {
    ...
    private static Builder<PlacementModifier> treePlacementBase(PlacementModifier countModifier) {
        return ImmutableList.<PlacementModifier>builder().add(countModifier).add(InSquarePlacement.spread()).add(TREE_THRESHOLD).add(PlacementUtils.HEIGHTMAP_OCEAN_FLOOR).add(BiomeFilter.biome());
    }
