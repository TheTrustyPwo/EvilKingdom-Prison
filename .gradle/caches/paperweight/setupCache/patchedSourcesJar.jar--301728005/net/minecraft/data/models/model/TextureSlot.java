...
public final class TextureSlot {
    ...
    private static TextureSlot create(String name) {
        return new TextureSlot(name, (TextureSlot)null);
    }

    private static TextureSlot create(String name, TextureSlot parent) {
        return new TextureSlot(name, parent);
    }

    private TextureSlot(String name, @Nullable TextureSlot parent) {
        this.id = name;
        this.parent = parent;
    }
