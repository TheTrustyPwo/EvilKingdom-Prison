...
public class BlockModelGenerators {
    ...
    public static final Map<BooleanProperty, Function<ResourceLocation, Variant>> MULTIFACE_GENERATOR = Util.make(Maps.newHashMap(), (map) -> {
        map.put(BlockStateProperties.NORTH, (id) -> {
            return Variant.variant().with(VariantProperties.MODEL, id);
        });
        map.put(BlockStateProperties.EAST, (id) -> {
        ...
        map.put(BlockStateProperties.SOUTH, (id) -> {
        ...
        map.put(BlockStateProperties.WEST, (id) -> {
        ...
        map.put(BlockStateProperties.UP, (id) -> {
        ...
        map.put(BlockStateProperties.DOWN, (id) -> {
    ...
    private static BlockStateGenerator createMirroredCubeGenerator(Block block, ResourceLocation modelId, TextureMapping textures, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelCollector) {
    ...
    private static BlockStateGenerator createMirroredColumnGenerator(Block block, ResourceLocation modelId, TextureMapping textures, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelCollector) {
    ...
    public BlockModelGenerators(Consumer<BlockStateGenerator> blockStateCollector, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelCollector, Consumer<Item> simpleItemModelExemptionCollector) {
    ...
    private static PropertyDispatch.C4<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> configureDoorHalf(PropertyDispatch.C4<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> variantMap, DoubleBlockHalf targetHalf, ResourceLocation regularModel, ResourceLocation hingeModel) {
        return variantMap.select(Direction.EAST, targetHalf, DoorHingeSide.LEFT, false, Variant.variant().with(VariantProperties.MODEL, regularModel)).select(Direction.SOUTH, targetHalf, DoorHingeSide.LEFT, false, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, targetHalf, DoorHingeSide.LEFT, false, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.NORTH, targetHalf, DoorHingeSide.LEFT, false, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.EAST, targetHalf, DoorHingeSide.RIGHT, false, Variant.variant().with(VariantProperties.MODEL, hingeModel)).select(Direction.SOUTH, targetHalf, DoorHingeSide.RIGHT, false, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, targetHalf, DoorHingeSide.RIGHT, false, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.NORTH, targetHalf, DoorHingeSide.RIGHT, false, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.EAST, targetHalf, DoorHingeSide.LEFT, true, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.SOUTH, targetHalf, DoorHingeSide.LEFT, true, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.WEST, targetHalf, DoorHingeSide.LEFT, true, Variant.variant().with(VariantProperties.MODEL, hingeModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.NORTH, targetHalf, DoorHingeSide.LEFT, true, Variant.variant().with(VariantProperties.MODEL, hingeModel)).select(Direction.EAST, targetHalf, DoorHingeSide.RIGHT, true, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.SOUTH, targetHalf, DoorHingeSide.RIGHT, true, Variant.variant().with(VariantProperties.MODEL, regularModel)).select(Direction.WEST, targetHalf, DoorHingeSide.RIGHT, true, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.NORTH, targetHalf, DoorHingeSide.RIGHT, true, Variant.variant().with(VariantProperties.MODEL, regularModel).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180));
    }

    private static BlockStateGenerator createDoor(Block doorBlock, ResourceLocation bottomModelId, ResourceLocation bottomHingeModelId, ResourceLocation topModelId, ResourceLocation topHingeModelId) {
        return MultiVariantGenerator.multiVariant(doorBlock).with(configureDoorHalf(configureDoorHalf(PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.DOUBLE_BLOCK_HALF, BlockStateProperties.DOOR_HINGE, BlockStateProperties.OPEN), DoubleBlockHalf.LOWER, bottomModelId, bottomHingeModelId), DoubleBlockHalf.UPPER, topModelId, topHingeModelId));
    }

    static BlockStateGenerator createFence(Block fenceBlock, ResourceLocation postModelId, ResourceLocation sideModelId) {
        return MultiPartGenerator.multiPart(fenceBlock).with(Variant.variant().with(VariantProperties.MODEL, postModelId)).with(Condition.condition().term(BlockStateProperties.NORTH, true), Variant.variant().with(VariantProperties.MODEL, sideModelId).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.EAST, true), Variant.variant().with(VariantProperties.MODEL, sideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.SOUTH, true), Variant.variant().with(VariantProperties.MODEL, sideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.WEST, true), Variant.variant().with(VariantProperties.MODEL, sideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true));
    }
    ...
    static BlockStateGenerator createWall(Block wallBlock, ResourceLocation postModelId, ResourceLocation lowSideModelId, ResourceLocation tallSideModelId) {
        return MultiPartGenerator.multiPart(wallBlock).with(Condition.condition().term(BlockStateProperties.UP, true), Variant.variant().with(VariantProperties.MODEL, postModelId)).with(Condition.condition().term(BlockStateProperties.NORTH_WALL, WallSide.LOW), Variant.variant().with(VariantProperties.MODEL, lowSideModelId).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.EAST_WALL, WallSide.LOW), Variant.variant().with(VariantProperties.MODEL, lowSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.SOUTH_WALL, WallSide.LOW), Variant.variant().with(VariantProperties.MODEL, lowSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.WEST_WALL, WallSide.LOW), Variant.variant().with(VariantProperties.MODEL, lowSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.NORTH_WALL, WallSide.TALL), Variant.variant().with(VariantProperties.MODEL, tallSideModelId).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.EAST_WALL, WallSide.TALL), Variant.variant().with(VariantProperties.MODEL, tallSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.SOUTH_WALL, WallSide.TALL), Variant.variant().with(VariantProperties.MODEL, tallSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true)).with(Condition.condition().term(BlockStateProperties.WEST_WALL, WallSide.TALL), Variant.variant().with(VariantProperties.MODEL, tallSideModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true));
    }

    static BlockStateGenerator createFenceGate(Block fenceGateBlock, ResourceLocation openModelId, ResourceLocation closedModelId, ResourceLocation openWallModelId, ResourceLocation closedWallModelId) {
        return MultiVariantGenerator.multiVariant(fenceGateBlock, Variant.variant().with(VariantProperties.UV_LOCK, true)).with(createHorizontalFacingDispatchAlt()).with(PropertyDispatch.properties(BlockStateProperties.IN_WALL, BlockStateProperties.OPEN).select(false, false, Variant.variant().with(VariantProperties.MODEL, closedModelId)).select(true, false, Variant.variant().with(VariantProperties.MODEL, closedWallModelId)).select(false, true, Variant.variant().with(VariantProperties.MODEL, openModelId)).select(true, true, Variant.variant().with(VariantProperties.MODEL, openWallModelId)));
    }
    ...
    private static BlockStateGenerator createOrientableTrapdoor(Block trapdoorBlock, ResourceLocation topModelId, ResourceLocation bottomModelId, ResourceLocation openModelId) {
        return MultiVariantGenerator.multiVariant(trapdoorBlock).with(PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(Direction.SOUTH, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.NORTH, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(Direction.SOUTH, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.EAST, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.NORTH, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId)).select(Direction.SOUTH, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.SOUTH, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R0)).select(Direction.EAST, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.WEST, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)));
    }

    private static BlockStateGenerator createTrapdoor(Block trapdoorBlock, ResourceLocation topModelId, ResourceLocation bottomModelId, ResourceLocation openModelId) {
        return MultiVariantGenerator.multiVariant(trapdoorBlock).with(PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).select(Direction.NORTH, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(Direction.SOUTH, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(Direction.EAST, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(Direction.WEST, Half.BOTTOM, false, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(Direction.NORTH, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(Direction.SOUTH, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(Direction.EAST, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(Direction.WEST, Half.TOP, false, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(Direction.NORTH, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId)).select(Direction.SOUTH, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.EAST, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, Half.BOTTOM, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(Direction.NORTH, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId)).select(Direction.SOUTH, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(Direction.EAST, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(Direction.WEST, Half.TOP, true, Variant.variant().with(VariantProperties.MODEL, openModelId).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)));
    }
    ...
    static BlockStateGenerator createRotatedPillarWithHorizontalVariant(Block block, ResourceLocation verticalModelId, ResourceLocation horizontalModelId) {
        return MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AXIS).select(Direction.Axis.Y, Variant.variant().with(VariantProperties.MODEL, verticalModelId)).select(Direction.Axis.Z, Variant.variant().with(VariantProperties.MODEL, horizontalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)).select(Direction.Axis.X, Variant.variant().with(VariantProperties.MODEL, horizontalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)));
    }
    ...
    void createDoor(Block doorBlock) {
        ...
        ResourceLocation resourceLocation = ModelTemplates.DOOR_BOTTOM.create(doorBlock, textureMapping, this.modelOutput);
        ResourceLocation resourceLocation2 = ModelTemplates.DOOR_BOTTOM_HINGE.create(doorBlock, textureMapping, this.modelOutput);
        ResourceLocation resourceLocation3 = ModelTemplates.DOOR_TOP.create(doorBlock, textureMapping, this.modelOutput);
        ResourceLocation resourceLocation4 = ModelTemplates.DOOR_TOP_HINGE.create(doorBlock, textureMapping, this.modelOutput);
    ...
    private void createStems(Block stemBlock, Block attachedStemBlock) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(stemBlock).with(PropertyDispatch.property(BlockStateProperties.AGE_7).generate((integer) -> {
    ...
    private void createSunflower() {
        ...
        ResourceLocation resourceLocation2 = this.createSuffixedVariant(Blocks.SUNFLOWER, "_bottom", BlockModelGenerators.TintState.NOT_TINTED.getCross(), TextureMapping::cross);
    ...
    private void createSmallDripleaf() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SMALL_DRIPLEAF).with(createHorizontalFacingDispatch()).with(PropertyDispatch.property(BlockStateProperties.DOUBLE_BLOCK_HALF).select(DoubleBlockHalf.LOWER, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(DoubleBlockHalf.UPPER, Variant.variant().with(VariantProperties.MODEL, resourceLocation))));
    }

    private void createDoubleBlock(Block block, ResourceLocation upperHalfModelId, ResourceLocation lowerHalfModelId) {
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.DOUBLE_BLOCK_HALF).select(DoubleBlockHalf.LOWER, Variant.variant().with(VariantProperties.MODEL, lowerHalfModelId)).select(DoubleBlockHalf.UPPER, Variant.variant().with(VariantProperties.MODEL, upperHalfModelId))));
    }
    ...
    private void createActiveRail(Block rail) {
        ...
        PropertyDispatch propertyDispatch = PropertyDispatch.properties(BlockStateProperties.POWERED, BlockStateProperties.RAIL_SHAPE_STRAIGHT).generate((boolean_, shape) -> {
            switch(shape) {
            case NORTH_SOUTH:
    ...
    private void createCommandBlock(Block commandBlock) {
        ...
        ResourceLocation resourceLocation2 = this.createSuffixedVariant(commandBlock, "_conditional", ModelTemplates.COMMAND_BLOCK, (id) -> {
            return textureMapping.copyAndUpdate(TextureSlot.SIDE, id);
        });
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(commandBlock).with(createBooleanModelDispatch(BlockStateProperties.CONDITIONAL, resourceLocation2, resourceLocation)).with(createFacingDispatch()));
    }
    ...
    private static <T extends Comparable<T>> PropertyDispatch createEmptyOrFullDispatch(Property<T> property, T fence, ResourceLocation higherOrEqualModelId, ResourceLocation lowerModelId) {
    ...
    private void createBeeNest(Block beehive, Function<Block, TextureMapping> texturesFactory) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(beehive).with(createHorizontalFacingDispatch()).with(createEmptyOrFullDispatch(BlockStateProperties.LEVEL_HONEY, 5, resourceLocation2, resourceLocation)));
    }
    ...
    private void createFurnace(Block cooker, TexturedModel.Provider modelFactory) {
        ...
        ResourceLocation resourceLocation3 = modelFactory.get(cooker).updateTextures((textures) -> {
            textures.put(TextureSlot.FRONT, resourceLocation2);
        }).createWithSuffix(cooker, "_on", this.modelOutput);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(cooker).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation3, resourceLocation)).with(createHorizontalFacingDispatch()));
    }
    ...
    private void createCampfires(Block... blocks) {
        ...
        for(Block block : blocks) {
            ...
            this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation2, resourceLocation)).with(createHorizontalFacingDispatchAlt()));
        }
    ...
    private void createPumpkinVariant(Block block, TextureMapping texture) {
        ResourceLocation resourceLocation = ModelTemplates.CUBE_ORIENTABLE.create(block, texture.copyAndUpdate(TextureSlot.FRONT, TextureMapping.getBlockTexture(block)), this.modelOutput);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with(createHorizontalFacingDispatch()));
    }
    ...
    private void createChorusFlower() {
        ...
        ResourceLocation resourceLocation2 = this.createSuffixedVariant(Blocks.CHORUS_FLOWER, "_dead", ModelTemplates.CHORUS_FLOWER, (id) -> {
            return textureMapping.copyAndUpdate(TextureSlot.TEXTURE, id);
        });
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CHORUS_FLOWER).with(createEmptyOrFullDispatch(BlockStateProperties.AGE_5, 5, resourceLocation2, resourceLocation)));
    }
    ...
    private void createDaylightDetector() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.DAYLIGHT_DETECTOR).with(PropertyDispatch.property(BlockStateProperties.INVERTED).select(false, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.DAYLIGHT_DETECTOR.create(Blocks.DAYLIGHT_DETECTOR, textureMapping, this.modelOutput))).select(true, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.DAYLIGHT_DETECTOR.create(ModelLocationUtils.getModelLocation(Blocks.DAYLIGHT_DETECTOR, "_inverted"), textureMapping2, this.modelOutput)))));
    }
    ...
    private void createLightningRod() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block))).with(this.createColumnWithFacing()).with(createBooleanModelDispatch(BlockStateProperties.POWERED, resourceLocation, resourceLocation2)));
    }
    ...
    private void createFarmland() {
        ...
        ResourceLocation resourceLocation2 = ModelTemplates.FARMLAND.create(TextureMapping.getBlockTexture(Blocks.FARMLAND, "_moist"), textureMapping2, this.modelOutput);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.FARMLAND).with(createEmptyOrFullDispatch(BlockStateProperties.MOISTURE, 7, resourceLocation2, resourceLocation)));
    }

    private List<ResourceLocation> createFloorFireModels(Block texture) {
        ResourceLocation resourceLocation = ModelTemplates.FIRE_FLOOR.create(ModelLocationUtils.getModelLocation(texture, "_floor0"), TextureMapping.fire0(texture), this.modelOutput);
        ResourceLocation resourceLocation2 = ModelTemplates.FIRE_FLOOR.create(ModelLocationUtils.getModelLocation(texture, "_floor1"), TextureMapping.fire1(texture), this.modelOutput);
    ...
    private List<ResourceLocation> createSideFireModels(Block texture) {
        ResourceLocation resourceLocation = ModelTemplates.FIRE_SIDE.create(ModelLocationUtils.getModelLocation(texture, "_side0"), TextureMapping.fire0(texture), this.modelOutput);
        ResourceLocation resourceLocation2 = ModelTemplates.FIRE_SIDE.create(ModelLocationUtils.getModelLocation(texture, "_side1"), TextureMapping.fire1(texture), this.modelOutput);
        ResourceLocation resourceLocation3 = ModelTemplates.FIRE_SIDE_ALT.create(ModelLocationUtils.getModelLocation(texture, "_side_alt0"), TextureMapping.fire0(texture), this.modelOutput);
        ResourceLocation resourceLocation4 = ModelTemplates.FIRE_SIDE_ALT.create(ModelLocationUtils.getModelLocation(texture, "_side_alt1"), TextureMapping.fire1(texture), this.modelOutput);
    ...
    private List<ResourceLocation> createTopFireModels(Block texture) {
        ResourceLocation resourceLocation = ModelTemplates.FIRE_UP.create(ModelLocationUtils.getModelLocation(texture, "_up0"), TextureMapping.fire0(texture), this.modelOutput);
        ResourceLocation resourceLocation2 = ModelTemplates.FIRE_UP.create(ModelLocationUtils.getModelLocation(texture, "_up1"), TextureMapping.fire1(texture), this.modelOutput);
        ResourceLocation resourceLocation3 = ModelTemplates.FIRE_UP_ALT.create(ModelLocationUtils.getModelLocation(texture, "_up_alt0"), TextureMapping.fire0(texture), this.modelOutput);
        ResourceLocation resourceLocation4 = ModelTemplates.FIRE_UP_ALT.create(ModelLocationUtils.getModelLocation(texture, "_up_alt1"), TextureMapping.fire1(texture), this.modelOutput);
        return ImmutableList.of(resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4);
    }
    ...
    private void createFire() {
        ...
        this.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.FIRE).with(condition, wrapModels(list, (variant) -> {
            return variant;
        })).with(Condition.or(Condition.condition().term(BlockStateProperties.NORTH, true), condition), wrapModels(list2, (variant) -> {
            return variant;
        })).with(Condition.or(Condition.condition().term(BlockStateProperties.EAST, true), condition), wrapModels(list2, (variant) -> {
            return variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90);
        })).with(Condition.or(Condition.condition().term(BlockStateProperties.SOUTH, true), condition), wrapModels(list2, (variant) -> {
            return variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180);
        })).with(Condition.or(Condition.condition().term(BlockStateProperties.WEST, true), condition), wrapModels(list2, (variant) -> {
            return variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270);
        })).with(Condition.condition().term(BlockStateProperties.UP, true), wrapModels(list3, (variant) -> {
            return variant;
        })));
    }
    ...
    private void createLantern(Block lantern) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(lantern).with(createBooleanModelDispatch(BlockStateProperties.HANGING, resourceLocation2, resourceLocation)));
    }
    ...
    private void createGrassBlocks() {
        ...
        ResourceLocation resourceLocation2 = TexturedModel.CUBE_TOP_BOTTOM.get(Blocks.MYCELIUM).updateTextures((textures) -> {
            textures.put(TextureSlot.BOTTOM, resourceLocation);
        }).create(Blocks.MYCELIUM, this.modelOutput);
        this.createGrassLikeBlock(Blocks.MYCELIUM, resourceLocation2, variant);
        ResourceLocation resourceLocation3 = TexturedModel.CUBE_TOP_BOTTOM.get(Blocks.PODZOL).updateTextures((textures) -> {
            textures.put(TextureSlot.BOTTOM, resourceLocation);
    ...
    private void createGrassLikeBlock(Block topSoil, ResourceLocation modelId, Variant snowyVariant) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(topSoil).with(PropertyDispatch.property(BlockStateProperties.SNOWY).select(true, snowyVariant).select(false, list)));
    }
    ...
    private void createWeightedPressurePlate(Block pressurePlate, Block textureSource) {
        ...
        ResourceLocation resourceLocation2 = ModelTemplates.PRESSURE_PLATE_DOWN.create(pressurePlate, textureMapping, this.modelOutput);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(pressurePlate).with(createEmptyOrFullDispatch(BlockStateProperties.POWER, 1, resourceLocation2, resourceLocation)));
    }
    ...
    private void createObserver() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.OBSERVER).with(createBooleanModelDispatch(BlockStateProperties.POWERED, resourceLocation2, resourceLocation)).with(createFacingDispatch()));
    }
    ...
    private void createPistons() {
        ...
        ResourceLocation resourceLocation4 = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.PISTON, "_inventory", textureMapping.copyAndUpdate(TextureSlot.TOP, resourceLocation2), this.modelOutput);
        ResourceLocation resourceLocation5 = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.STICKY_PISTON, "_inventory", textureMapping.copyAndUpdate(TextureSlot.TOP, resourceLocation), this.modelOutput);
    ...
    private void createPistonVariant(Block piston, ResourceLocation extendedModelId, TextureMapping textures) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(piston).with(createBooleanModelDispatch(BlockStateProperties.EXTENDED, extendedModelId, resourceLocation)).with(createFacingDispatch()));
    }
    ...
    private void createScaffolding() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SCAFFOLDING).with(createBooleanModelDispatch(BlockStateProperties.BOTTOM, resourceLocation2, resourceLocation)));
    }
    ...
    private void createCaveVines() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CAVE_VINES).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, resourceLocation2, resourceLocation)));
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CAVE_VINES_PLANT).with(createBooleanModelDispatch(BlockStateProperties.BERRIES, resourceLocation4, resourceLocation3)));
    }
    ...
    private void createRedstoneLamp() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.REDSTONE_LAMP).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation2, resourceLocation)));
    }
    ...
    private void createRedstoneTorch() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.REDSTONE_TORCH).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation, resourceLocation2)));
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.REDSTONE_WALL_TORCH).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation3, resourceLocation4)).with(createTorchHorizontalDispatch()));
    ...
    private void createRepeater() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.REPEATER).with(PropertyDispatch.properties(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED).generate((integer, boolean_, boolean2) -> {
    ...
    private void createSnowBlocks() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SNOW).with(PropertyDispatch.property(BlockStateProperties.LAYERS).generate((integer) -> {
    ...
    private void createSweetBerryBush() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SWEET_BERRY_BUSH).with(PropertyDispatch.property(BlockStateProperties.AGE_3).generate((integer) -> {
    ...
    private void createTripwireHook() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.TRIPWIRE_HOOK).with(PropertyDispatch.properties(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED).generate((boolean_, boolean2) -> {
    ...
    private ResourceLocation createTurtleEggModel(int eggs, String prefix, TextureMapping textures) {
        ...
        case 2:
            return ModelTemplates.TWO_TURTLE_EGGS.create(ModelLocationUtils.decorateBlockModelLocation("two_" + prefix + "turtle_eggs"), textures, this.modelOutput);
        case 3:
            return ModelTemplates.THREE_TURTLE_EGGS.create(ModelLocationUtils.decorateBlockModelLocation("three_" + prefix + "turtle_eggs"), textures, this.modelOutput);
        case 4:
            return ModelTemplates.FOUR_TURTLE_EGGS.create(ModelLocationUtils.decorateBlockModelLocation("four_" + prefix + "turtle_eggs"), textures, this.modelOutput);
        default:
    ...
    private void createTurtleEgg() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.TURTLE_EGG).with(PropertyDispatch.properties(BlockStateProperties.EGGS, BlockStateProperties.HATCH).generateList((integer, integer2) -> {
    ...
    private void createShulkerBox(Block shulkerBox) {
        ...
        ModelTemplates.SHULKER_BOX_INVENTORY.create(ModelLocationUtils.getModelLocation(shulkerBox.asItem()), TextureMapping.particle(shulkerBox), this.modelOutput);
    }
    ...
    private void createRespawnAnchor() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.RESPAWN_ANCHOR).with(PropertyDispatch.property(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate((integer) -> {
    ...
    private void createJigsaw() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.JIGSAW, Variant.variant().with(VariantProperties.MODEL, resourceLocation5)).with(PropertyDispatch.property(BlockStateProperties.ORIENTATION).generate((frontAndTop) -> {
    ...
    public void run() {
        ...
        SpawnEggItem.eggs().forEach((item) -> {
    ...
    private void createCandleAndCandleCake(Block candle, Block cake) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(candle).with(PropertyDispatch.properties(BlockStateProperties.CANDLES, BlockStateProperties.LIT).select(1, false, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(2, false, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(3, false, Variant.variant().with(VariantProperties.MODEL, resourceLocation3)).select(4, false, Variant.variant().with(VariantProperties.MODEL, resourceLocation4)).select(1, true, Variant.variant().with(VariantProperties.MODEL, resourceLocation5)).select(2, true, Variant.variant().with(VariantProperties.MODEL, resourceLocation6)).select(3, true, Variant.variant().with(VariantProperties.MODEL, resourceLocation7)).select(4, true, Variant.variant().with(VariantProperties.MODEL, resourceLocation8))));
        ...
        ResourceLocation resourceLocation10 = ModelTemplates.CANDLE_CAKE.createWithSuffix(cake, "_lit", TextureMapping.candleCake(candle, true), this.modelOutput);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(cake).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourceLocation10, resourceLocation9)));
    }
    ...
    class BlockFamilyProvider {
        ...
        public BlockModelGenerators.BlockFamilyProvider fenceGate(Block fenceGateBlock) {
            ...
            ResourceLocation resourceLocation3 = ModelTemplates.FENCE_GATE_WALL_OPEN.create(fenceGateBlock, this.mapping, BlockModelGenerators.this.modelOutput);
            ResourceLocation resourceLocation4 = ModelTemplates.FENCE_GATE_WALL_CLOSED.create(fenceGateBlock, this.mapping, BlockModelGenerators.this.modelOutput);
        ...
        public BlockModelGenerators.BlockFamilyProvider pressurePlate(Block pressurePlateBlock) {
            ...
            ResourceLocation resourceLocation2 = ModelTemplates.PRESSURE_PLATE_DOWN.create(pressurePlateBlock, this.mapping, BlockModelGenerators.this.modelOutput);
    ...
    interface BlockStateGeneratorSupplier {
        BlockStateGenerator create(Block block, ResourceLocation modelId, TextureMapping textures, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelCollector);
    }
