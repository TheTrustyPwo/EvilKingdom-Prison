...
public class TexturedModel {
    ...
    private TexturedModel(TextureMapping textures, ModelTemplate model) {
    ...
    public TexturedModel updateTextures(Consumer<TextureMapping> texturesConsumer) {
        texturesConsumer.accept(this.mapping);
        return this;
    }

    public ResourceLocation create(Block block, BiConsumer<ResourceLocation, Supplier<JsonElement>> writer) {
        return this.template.create(block, this.mapping, writer);
    }

    public ResourceLocation createWithSuffix(Block block, String suffix, BiConsumer<ResourceLocation, Supplier<JsonElement>> writer) {
        return this.template.createWithSuffix(block, suffix, this.mapping, writer);
    }

    private static TexturedModel.Provider createDefault(Function<Block, TextureMapping> texturesGetter, ModelTemplate model) {
        return (block) -> {
            return new TexturedModel(texturesGetter.apply(block), model);
        };
    }

    public static TexturedModel createAllSame(ResourceLocation id) {
    ...
    public interface Provider {
        ...
        default ResourceLocation create(Block block, BiConsumer<ResourceLocation, Supplier<JsonElement>> writer) {
            return this.get(block).create(block, writer);
        }

        default ResourceLocation createWithSuffix(Block block, String suffix, BiConsumer<ResourceLocation, Supplier<JsonElement>> writer) {
            return this.get(block).createWithSuffix(block, suffix, writer);
        }
