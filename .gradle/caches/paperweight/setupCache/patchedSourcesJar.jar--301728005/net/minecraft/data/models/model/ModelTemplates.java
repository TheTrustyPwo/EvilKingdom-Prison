...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = IntStream.range(0, 8).mapToObj((i) -> {
        return create("stem_growth" + i, "_stage" + i, TextureSlot.STEM);
    }).toArray((i) -> {
        return new ModelTemplate[i];
    });
    ...
    private static ModelTemplate create(String parent, TextureSlot... requiredTextureKeys) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + parent)), Optional.empty(), requiredTextureKeys);
    }

    private static ModelTemplate createItem(String parent, TextureSlot... requiredTextureKeys) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + parent)), Optional.empty(), requiredTextureKeys);
    }
